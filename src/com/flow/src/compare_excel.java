 ...
 * 编程思路：
 * 
 * 1.读file1的{File}列装进set中 2.读file2的{File}列装进set2中 3.求非交集 4.排查分为两个部分，【1】非交集部分
 * 【2】交集部分少或多的部分
 *
 * 5.两个文件重新一点点载入 【1】 判断哪里的非交集，文字标红【在file3中写出来】 【2】 file2 的 {Line+Description}
 * 与file1 的对应部分相对比 不一样的在file2中标出 set中剩下的在file1中标出 【在另一个文件file3中写出来】
 * 
 * 2016-9-5 修改成批量处理分析
 * 
...
public class compare_excel {
	...
	public final String filename = "/pmd-final.txt";// 拼接串2
